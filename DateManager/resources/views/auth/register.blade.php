                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names" value="{{ old('names') }}" required autocomplete="names">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lastnames" type="text" class="form-control @error('lastnames') is-invalid @enderror" name="lastnames" value="{{ old('lastnames') }}" required autocomplete="lastnames">
